...
const Dashboard = () => {
  return (
    <div className="flex flex-col min-h-screen">
      <TaskBar />
      <div className="flex-1 md:ml-[20%] lg:ml-[16.666%] pt-[70px]"> {/* Add padding-top to account for TaskBar */}
        ...
        <div className="income-expenses-container items-center flex w-full text-lg text-white p-10 pt-0 rounded-full">
          <div className="glass income-container p-4 flex-1 bg-[#9747FF] border border-white rounded-lg">
            <i className="fs-4 bi-arrow-down-circle pr-2"></i>
            Income
            <div className="income-amount text-md font-bold">Php 2,548.00</div>
          </div>
          <div className="glass expenses-container p-4 flex-1 bg-[#9747FF] border border-white rounded-lg ml-4">
        ...
        <div className="p-10 pt-0">
          <div className="glass collapse collapse-arrow max-w-2xl w-full bg-blue-950 p-3 rounded-lg shadow- overflow-hidden mb-4">
