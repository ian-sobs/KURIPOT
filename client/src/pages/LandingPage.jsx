    ...
    <>
      ...
      <div className="slogan-container w-full bg-center-vertical p-6">
        <div className="slogan-container-content h-[250px] w-full flex items-center justify-between">
          ...
          <div className="slogan-container-media-placeholder">placeholder</div>
        </div>
      </div>
      ...
      <div className="landing-container w-full flex-col justify-center items-center overflow-hidden">
        ...
        >
          {/* Different width and margin-right due to the sticking out graphic */}
          <div className="carousel-item flex-shrink-0 snap-center flex justify-center items-center w-[272px] overflow-hidden">
            <img
              src="/images/Carousel-first.png"
              className="rounded-box object-contain w-full h-auto"
              alt="carousel-item"
            />
          </div>
          <div className="carousel-item flex-shrink-0 snap-center flex justify-center items-center w-[250px] mr-5 overflow-hidden">
            <img
