    ...
    <div className="flex flex-col h-screen">
      ...
      <div className="flex-1 md:ml-[20%] lg:ml-[16.666%]">
        ...
        <div className="mt-16 flex items-center justify-center">
          <div className="items-center w-full max-w-md p-6 rounded-lg shadow-md m-10 bg-gradient-to-r from-[#180655]/20 via-[#15172E]/20 to-[#180655]/20 text-white ">
            {error && (
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="account" className="block text-white">
                  Account
                </label>
                <select
                  id="account"
