...
const {getAggrTransac} = require('../controllers/transactions/getAggrTransac')
const {getAggrMonthTransac} = require('../controllers/transactions/getAggrMonthTransac')
const {getAggrDayTransac} = require('../controllers/transactions/getAggrDayTransac')
const {getAggrWeekTransac} = require('../controllers/transactions/getAggrWeekTransac')
...
transactionsRouter.get('/getAggregateTransaction', getAggrTransac)
transactionsRouter.get('/getAggrMonthTransactions', getAggrMonthTransac)
transactionsRouter.get('/getAggrDayTransactions', getAggrDayTransac)
transactionsRouter.get('/getAggrWeekTransaction', getAggrWeekTransac)
